    ...
    <>
      <form onSubmit={onSubmit}>
        <div className="space-y-12 sm:space-y-16">
          <div>
            ...
            <div className="mt-10 space-y-8 border-b border-gray-900/10 pb-12 sm:space-y-0 sm:divide-y sm:divide-gray-900/10 sm:border-t sm:pb-0">
              ...
              <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                <label htmlFor="post_title" className="block text-sm font-medium leading-6 text-gray-900 sm:pt-1.5">
              ...
              {/*PRODUCT URL*/}
              <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                <label htmlFor="post_url" className="block text-sm font-medium leading-6 text-gray-900 sm:pt-1.5">
                  Url del producto
                </label>
                <div className="mt-2 sm:col-span-2 sm:mt-0">
                  <input
              ...
              <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                ...
                <div className="mt-2 sm:col-span-2 sm:mt-0">
                  ...
                  <p className="mt-3 text-sm leading-6 text-gray-600">
                    Escribe una breve descripción del producto que quieres comprar.
                  </p>
                </div>
              </div>
              ...
              {/*REREFENCE IMG*/}
              <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                <label htmlFor="img_url" className="block text-sm font-medium leading-6 text-gray-900 sm:pt-1.5">
          ...
          {/*BUYING DETAILS*/}
          <div>
            <h2 className="text-base font-semibold leading-7 text-gray-900">Detalles de la compra</h2>
            <p className="mt-1 max-w-2xl text-sm leading-6 text-gray-600">
            ...
            <div className="mt-10 space-y-8 border-b border-gray-900/10 pb-12 sm:space-y-0 sm:divide-y sm:divide-gray-900/10 sm:border-t sm:pb-0">
              {/*MINIMUM UNITS*/}
              <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                <label htmlFor="min_units" className="block text-sm font-medium leading-6 text-gray-900 sm:pt-1.5">
              ...
              {/*UNIT PRICE*/}
              <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                <label htmlFor="unit_price" className="block text-sm font-medium leading-6 text-gray-900 sm:pt-1.5">
                  Precio unitario
                </label>
                <div className="mt-2 sm:col-span-2 sm:mt-0">
                  <input
              ...
              {/*EXPITRATION DATE*/}
              <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                <label htmlFor="exp_date" className="block text-sm font-medium leading-6 text-gray-900 sm:pt-1.5">
        ...
        <div className="mt-6 flex items-center justify-end gap-x-6">
          <Link type="button" className="text-sm font-semibold leading-6 text-gray-900 hover:text-red-500">
            Cancel
          </Link>
